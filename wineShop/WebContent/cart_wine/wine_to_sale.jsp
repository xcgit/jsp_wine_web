...
%>
	...
	<div id="content" >
		...
		<form name="wine_form" action="">
			...
			<div id="sub">
				<input type="submit" id="add_cart" onclick="a_cart()" value="加入购物车">
				<input type="submit" id="buy_now"value="立即购买"  onclick="b_now()">
			</div>
			</form>
		</div>
	...
	<%
		...
		while(re.next()){
			...
			<div class="comm_content"><textarea  cols="20" readonly="readonly" maxlength="144"><%=re.getString("comm_content") %></textarea>
			<br>

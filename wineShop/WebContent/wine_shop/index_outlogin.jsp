...
<head>
 ...
 <script type="text/javascript" src="../js/index_outlogin.js" charset="gbk"></script>
...
<script>
	...
	$(function(){
		...
		$("#search_form").attr("action", "index_outlogin.jsp");
		
		
		});
		
		$("#fi_page").attr("href","index_outlogin.jsp?search_content="+$(".swap_value").val()+"&curPage=1"); 
		$("#la_page").attr("href","index_outlogin.jsp?search_content="+$(".swap_value").val()+"&curPage=<%=curPage-1%>"); 
		$("#ne_page").attr("href","index_outlogin.jsp?search_content="+$(".swap_value").val()+"&curPage=<%=curPage+1%>"); 
		$("#se_page").attr("href","index_outlogin.jsp?search_content="+$(".swap_value").val()+"&curPage=<%=pageCount%>"); 
	});
...
<input type="image" src="../picture/btn_rea.png" width="27" height="24" id="go" alt="Search" title="Search" /> 
		...
		<div id="middle">
			...
			<ul style="margin-top:10px;">
				...
				<li onclick="lg(4)">1-50</li>
				<li onclick="lg(5)">51-100</li>
				<li onclick="lg(6)">101-200</li>
				<li onclick="lg(7)">201-500</li>
				<li onclick="lg(8)">501-1000</li>
				<li onclick="lg(9)">1000以上</li>
					
			</ul>
			
			<ul class="du">
				<li class="the_one">度数：</li>
				<li onclick="lg_(11)">0-20度</li>
				<li onclick="lg_(12)">21-39度</li>
				<li onclick="lg_(13)">39度以上</li>
  ...
  <div class="yb_bar">
    <ul>
      ...
      <li class="yb_QQ">
      	  <a  href="tencent://message/?uin=2089719628&Site=sc.chinaz.com&Menu=yes">qq客服</a> </li>
...
%> 
    ...
    try{  
        ...
        do{  
            ...
            %>  
        <div >
				<a href="../cart_wine/wine_to_sale_outlogin.jsp?wId=<%=rs.getString(1) %>"><img src="../<%=rs.getString("wPicture") %>" style="opacity:0.9"></a>
				<input class="pric"type="text" readonly="readonly" value="¥<%=rs.getString("wPrice") %>">
					<a href="../cart_wine/wine_to_sale_outlogin.jsp?wId=<%=rs.getString(1) %>"><textarea ><%=rs.getString("wName") %></textarea></a>

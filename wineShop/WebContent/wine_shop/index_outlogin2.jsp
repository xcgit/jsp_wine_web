...
<head>
 ...
 <script type="text/javascript" src="../js/index_outlogin2.js" charset="gbk"></script>
...
<input type="image" src="../picture/btn_rea.png" width="27" height="24" id="go" alt="Search" title="Search" /> 
		...
		<div id="middle">
			...
			<ul class="du">
				...
				<li onclick="lg_(12)">21-40度</li>
				<li onclick="lg_(13)">40度以上</li>
...
%>  
	...
	<div id="bot">
	<div id="pa">
<a href = "index_outlogin2.jsp?curPage=1" >首页</a>  
<a href = "index_outlogin2.jsp?curPage=<%=curPage-1%>" >上一页</a>  
<a href = "index_outlogin2.jsp?curPage=<%=curPage+1%>" >下一页</a>  
<a href = "index_outlogin2.jsp?curPage=<%=pageCount%>" >尾页</a> 
